...
class _RequestPageState extends State<RequestPage> {
  ...
  Dio dio = DioClient().dio;
    ...
    try {
      ...
      var response = await dio.get<List<dynamic>>(
        '$baseUrl/contacts/requestFriendship',
        options: Options(
      ...
      response.data?.forEach((element) {
        print(element);
        Request request = Request.fromJson(element);
  ...
  Widget build(BuildContext context) {
    ...
    InkWell RequestCard(Request request, BuildContext context) {
    return InkWell(
      onTap: () {
        print(request.user!.username.toString());
 
        print(request.user!.id.toString());
      },
      child: Container(
